...
function useHardcodedData() {
  ...
  GAME_DATA.TRADE_POSTS = [
    ...
    {id:'knarr_core_trade_post_010',name:'貿易點 10',points:0,img:'knarr_core_trade_post_010.png',rewards:[{icon:'reputation',amount:2},{icon:'recruit_token',amount:1}],trade_cols:['victory_point','recruit_token',null],cost:{type:'different',count:2}},
    ...
    {id:'knarr_core_trade_post_013',name:'貿易點 13',points:0,img:'knarr_core_trade_post_013.png',rewards:[{icon:'silver_bracelet',amount:2},{icon:'recruit_token',amount:1}],trade_cols:['recruit_token','victory_point',null],cost:{type:'different',count:2}},
    ...
    {id:'knarr_core_trade_post_016',name:'貿易點 16',points:0,img:'knarr_core_trade_post_016.png',rewards:[{icon:'recruit_token',amount:1},{icon:'draw_crew_card',amount:1}],trade_cols:[null,'victory_point',null],cost:{type:'different',count:2}},
    {id:'knarr_core_trade_post_017',name:'貿易點 17',points:0,img:'knarr_core_trade_post_017.png',rewards:[{icon:'silver_bracelet',amount:1},{icon:'reputation',amount:1}],trade_cols:['victory_point',null,'victory_point'],cost:{type:'different',count:2}},
    {id:'knarr_core_trade_post_018',name:'貿易點 18',points:0,img:'knarr_core_trade_post_018.png',rewards:[{icon:'recruit_token',amount:2},{icon:'silver_bracelet',amount:1}],trade_cols:[null,'silver_bracelet',null],cost:{type:'different',count:2}},
