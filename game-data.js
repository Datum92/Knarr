...
function useHardcodedData() {
  ...
  GAME_DATA.SETTLEMENTS = [
    {id:'knarr_core_settlement_001',name:'定居點 01',points:8,img:'knarr_core_settlement_001.png',rewards:[{icon:'victory_point',amount:8},{icon:'draw_crew_card',amount:1}],trade_cols:['victory_point',null,'victory_point']},
    {id:'knarr_core_settlement_002',name:'定居點 02',points:6,img:'knarr_core_settlement_002.png',rewards:[{icon:'victory_point',amount:6}],trade_cols:[null,'victory_point',null]},
    {id:'knarr_core_settlement_003',name:'定居點 03',points:7,img:'knarr_core_settlement_003.png',rewards:[{icon:'victory_point',amount:7},{icon:'reputation',amount:2}],trade_cols:[null,null,'victory_point']},
    {id:'knarr_core_settlement_004',name:'定居點 04',points:6,img:'knarr_core_settlement_004.png',rewards:[{icon:'victory_point',amount:6}],trade_cols:['victory_point',null,null]},
    {id:'knarr_core_settlement_005',name:'定居點 05',points:5,img:'knarr_core_settlement_005.png',rewards:[{icon:'victory_point',amount:5},{icon:'recruit_token',amount:1}],trade_cols:['silver_bracelet',null,null]},
    {id:'knarr_core_settlement_006',name:'定居點 06',points:5,img:'knarr_core_settlement_006.png',rewards:[{icon:'victory_point',amount:5},{icon:'reputation',amount:1}],trade_cols:[null,null,'recruit_token']},
    {id:'knarr_core_settlement_007',name:'定居點 07',points:7,img:'knarr_core_settlement_007.png',rewards:[{icon:'victory_point',amount:7}],trade_cols:['victory_point',null,null]},
    {id:'knarr_core_settlement_008',name:'定居點 08',points:6,img:'knarr_core_settlement_008.png',rewards:[{icon:'victory_point',amount:6}],trade_cols:[null,null,'victory_point']},
    {id:'knarr_core_settlement_009',name:'定居點 09',points:8,img:'knarr_core_settlement_009.png',rewards:[{icon:'victory_point',amount:8}],trade_cols:[null,'recruit_token',null]},
    {id:'knarr_core_settlement_010',name:'定居點 10',points:6,img:'knarr_core_settlement_010.png',rewards:[{icon:'victory_point',amount:6},{icon:'silver_bracelet',amount:1}],trade_cols:['silver_bracelet',null,null]},
    {id:'knarr_core_settlement_011',name:'定居點 11',points:5,img:'knarr_core_settlement_011.png',rewards:[{icon:'victory_point',amount:5},{icon:'silver_bracelet',amount:1}],trade_cols:[null,null,'silver_bracelet']},
    {id:'knarr_core_settlement_012',name:'定居點 12',points:6,img:'knarr_core_settlement_012.png',rewards:[{icon:'victory_point',amount:6}],trade_cols:['victory_point',null,null]},
    {id:'knarr_core_settlement_013',name:'定居點 13',points:7,img:'knarr_core_settlement_013.png',rewards:[{icon:'victory_point',amount:7},{icon:'recruit_token',amount:1}],trade_cols:[null,'victory_point',null]},
    {id:'knarr_core_settlement_014',name:'定居點 14',points:6,img:'knarr_core_settlement_014.png',rewards:[{icon:'victory_point',amount:6}],trade_cols:[null,null,'victory_point']},
    {id:'knarr_core_settlement_015',name:'定居點 15',points:7,img:'knarr_core_settlement_015.png',rewards:[{icon:'victory_point',amount:7},{icon:'silver_bracelet',amount:1}],trade_cols:['victory_point',null,null]},
  ];

  // Trade Posts
  GAME_DATA.TRADE_POSTS = [
    {id:'knarr_core_trade_post_001',name:'貿易點 01',points:0,img:'knarr_core_trade_post_001.png',rewards:[{icon:'draw_crew_card',amount:1}],trade_cols:['victory_point','victory_point',null]},
    {id:'knarr_core_trade_post_002',name:'貿易點 02',points:0,img:'knarr_core_trade_post_002.png',rewards:[{icon:'recruit_token',amount:2}],trade_cols:[null,'victory_point','victory_point']},
    {id:'knarr_core_trade_post_003',name:'貿易點 03',points:0,img:'knarr_core_trade_post_003.png',rewards:[{icon:'silver_bracelet',amount:2}],trade_cols:['victory_point',null,'victory_point']},
    {id:'knarr_core_trade_post_004',name:'貿易點 04',points:0,img:'knarr_core_trade_post_004.png',rewards:[{icon:'reputation',amount:3}],trade_cols:['recruit_token',null,null]},
    {id:'knarr_core_trade_post_005',name:'貿易點 05',points:0,img:'knarr_core_trade_post_005.png',rewards:[{icon:'draw_crew_card',amount:2}],trade_cols:[null,'recruit_token',null]},
    {id:'knarr_core_trade_post_006',name:'貿易點 06',points:0,img:'knarr_core_trade_post_006.png',rewards:[{icon:'silver_bracelet',amount:1},{icon:'recruit_token',amount:1}],trade_cols:[null,null,'recruit_token']},
    {id:'knarr_core_trade_post_007',name:'貿易點 07',points:0,img:'knarr_core_trade_post_007.png',rewards:[{icon:'recruit_token',amount:1},{icon:'reputation',amount:2}],trade_cols:['silver_bracelet','silver_bracelet',null]},
    {id:'knarr_core_trade_post_008',name:'貿易點 08',points:0,img:'knarr_core_trade_post_008.png',rewards:[{icon:'victory_point',amount:2}],trade_cols:[null,'silver_bracelet','silver_bracelet']},
    {id:'knarr_core_trade_post_009',name:'貿易點 09',points:0,img:'knarr_core_trade_post_009.png',rewards:[{icon:'draw_crew_card',amount:1},{icon:'silver_bracelet',amount:1}],trade_cols:['silver_bracelet',null,'silver_bracelet']},
    {id:'knarr_core_trade_post_010',name:'貿易點 10',points:0,img:'knarr_core_trade_post_010.png',rewards:[{icon:'reputation',amount:2},{icon:'recruit_token',amount:1}],trade_cols:['victory_point','recruit_token',null]},
    {id:'knarr_core_trade_post_011',name:'貿易點 11',points:0,img:'knarr_core_trade_post_011.png',rewards:[{icon:'silver_bracelet',amount:1}],trade_cols:[null,'victory_point','recruit_token']},
    {id:'knarr_core_trade_post_012',name:'貿易點 12',points:0,img:'knarr_core_trade_post_012.png',rewards:[{icon:'recruit_token',amount:2},{icon:'draw_crew_card',amount:1}],trade_cols:['recruit_token',null,'victory_point']},
    {id:'knarr_core_trade_post_013',name:'貿易點 13',points:0,img:'knarr_core_trade_post_013.png',rewards:[{icon:'silver_bracelet',amount:2},{icon:'recruit_token',amount:1}],trade_cols:['recruit_token','victory_point',null]},
    {id:'knarr_core_trade_post_014',name:'貿易點 14',points:0,img:'knarr_core_trade_post_014.png',rewards:[{icon:'reputation',amount:4}],trade_cols:[null,'recruit_token','victory_point']},
    {id:'knarr_core_trade_post_015',name:'貿易點 15',points:0,img:'knarr_core_trade_post_015.png',rewards:[{icon:'draw_crew_card',amount:2},{icon:'reputation',amount:1}],trade_cols:['victory_point',null,'recruit_token']},
    {id:'knarr_core_trade_post_016',name:'貿易點 16',points:0,img:'knarr_core_trade_post_016.png',rewards:[{icon:'recruit_token',amount:1},{icon:'draw_crew_card',amount:1}],trade_cols:[null,'victory_point',null]},
    {id:'knarr_core_trade_post_017',name:'貿易點 17',points:0,img:'knarr_core_trade_post_017.png',rewards:[{icon:'silver_bracelet',amount:1},{icon:'reputation',amount:1}],trade_cols:['victory_point',null,'victory_point']},
    {id:'knarr_core_trade_post_018',name:'貿易點 18',points:0,img:'knarr_core_trade_post_018.png',rewards:[{icon:'recruit_token',amount:2},{icon:'silver_bracelet',amount:1}],trade_cols:[null,'silver_bracelet',null]},
    {id:'knarr_core_trade_post_019',name:'貿易點 19',points:0,img:'knarr_core_trade_post_019.png',rewards:[{icon:'draw_crew_card',amount:1},{icon:'recruit_token',amount:1}],trade_cols:['silver_bracelet',null,'silver_bracelet']},
    {id:'knarr_core_trade_post_020',name:'貿易點 20',points:0,img:'knarr_core_trade_post_020.png',rewards:[{icon:'reputation',amount:3},{icon:'silver_bracelet',amount:1}],trade_cols:[null,null,'silver_bracelet']},
  ];
}
